...
void handle_goal(const geometry_msgs::PoseStamped &goal) {
  ...
  tf2::Quaternion quat(0, 0, goal.pose.orientation.z, goal.pose.orientation.w);
...
void handle_initial_pose(const geometry_msgs::PoseWithCovarianceStamped &pose) {
  ...
  tf2::Quaternion quat(0, 0, pose.pose.pose.orientation.z, pose.pose.pose.orientation.w);
  tf2::Matrix3x3 matrix(quat);
  double roll, pitch, yaw;
  matrix.getRPY(roll, pitch, yaw);
